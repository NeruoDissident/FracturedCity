"""POPUP PANELS & INTERACTION UI - For clicking on game objects.

This module handles POPUP PANELS that appear when clicking on game objects:
- ColonistManagementPanel: Opens when clicking on a colonist
- BedAssignmentPanel: Opens when clicking on a bed
- FixerTradePanel: Opens when clicking on a trader/fixer
- VisitorPanel: Opens when clicking on a transient/wanderer
- StockpileFilterPanel: Opens when clicking on a stockpile zone
- ColonistJobTagsPanel: Small panel for toggling job tags

Also includes:
- ConstructionUI: Bottom action bar (Build/Zone/Harvest buttons)
- Keyboard shortcuts for quick access (B, Z, H)

NOTE: For structural UI (sidebars, top bar, layout), see ui_layout.py
NOTE: For workstation panels, see ui_workstation_new.py
"""
...
# ============================================================================
# ============================================================================
# NOTE: WorkstationPanel has been moved to ui_workstation_new.py
# This section was removed to eliminate redundancy.
# ============================================================================
